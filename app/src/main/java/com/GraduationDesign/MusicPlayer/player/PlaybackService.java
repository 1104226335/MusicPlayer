package com.GraduationDesign.MusicPlayer.player;
...
public class PlaybackService extends Service implements IPlayback, IPlayback.Callback {
    ...
    private static final String ACTION_PLAY_TOGGLE = "com.GraduationDesign.MusicPlayer.ACTION.PLAY_TOGGLE";
    private static final String ACTION_PLAY_LAST = "com.GraduationDesign.MusicPlayer.ACTION.PLAY_LAST";
    private static final String ACTION_PLAY_NEXT = "com.GraduationDesign.MusicPlayer.ACTION.PLAY_NEXT";
    private static final String ACTION_STOP_SERVICE = "com.GraduationDesign.MusicPlayer.ACTION.STOP_SERVICE";
    ...
    private void showNotification() {
        ...
        builder .setSmallIcon(R.drawable.ic_notification_app_logo)  // the status icon
